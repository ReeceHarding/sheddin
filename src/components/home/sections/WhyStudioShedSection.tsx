          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-gray-600">
                At Studio Shed, we combine innovative design with superior craftsmanship to create structures that stand the test of time.
              </p>
              <Link
                to="/design"
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="mt-4 text-sm italic text-gray-600">
                "We were amazed at how straightforward the Studio Shed process was. No cranes, no fuss - just a beautiful, functional space." - The Jumps, Arizona
              </p>
            </div>
          </div>
        );
  ...
  return (
    <section className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12">Why Studio Shed?</h2>
