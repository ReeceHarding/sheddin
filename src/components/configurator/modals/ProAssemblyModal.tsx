...
export const ProAssemblyModal: React.FC<ProAssemblyModalProps> = ({
  isOpen,
  onClose,
  onSelect,
}) => {
      ...
      <div className="relative min-h-screen flex items-center justify-center p-4">
        <div className="relative bg-white rounded-lg w-full max-w-2xl">
          ...
          <div className="flex justify-between items-center p-6 border-b">
            <h2 className="text-lg font-medium">Select your installation type</h2>
            <button
              onClick={onClose}
          ...
          <div className="p-6 space-y-8">
            ...
            <div className="border rounded-lg p-6">
              <h3 className="font-medium mb-4">Do-It-Yourself (DIY)</h3>
              ...
              <button
                ...
                className="w-full py-3 bg-primary text-white rounded-md hover:bg-primary-hover"
              >
                DIY Assembly
            ...
            {/* ProAssembly Option */}
            <div className="border rounded-lg p-6">
              <h3 className="font-medium mb-4">ProAssembly</h3>
